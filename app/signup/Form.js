...
var InputForm = function () {
  ...
  var setUsername = function (event) {
    ...
    setUserData(function (prevUserData) {
      return __assign(__assign({}, prevUserData), { username: newName });
    });
  };
  var setGender = function (event) {
    var newGender = event.target.value;
    setUserData(function (prevUserData) {
      return __assign(__assign({}, prevUserData), { gender: newGender });
    });
  };
  var setAge = function (event) {
    var newAge = parseInt(event.target.value);
    setUserData(function (prevUserData) {
      return __assign(__assign({}, prevUserData), { age: newAge });
    });
  };
